...
<link rel="stylesheet" href="{{url('backend/css/nice-icons.css')}}" />

<link rel="stylesheet" href="{{url('backend/css/owl.carousel.css')}}" />

<link rel="stylesheet" href="{{url('backend/css/gijgo.min.css')}}" />

<link rel="stylesheet" href="{{url('backend/css/all.min.css')}}" />
<link rel="stylesheet" href="{{url('backend/css/tagsinput.css')}}" />

<link rel="stylesheet" href="{{url('backend/css/date-picker.css')}}" />
<link rel="stylesheet" href="{{url('backend/css/vectormap-2.0.2.css')}}" />

<link rel="stylesheet" href="{{url('backend/css/scrollable.css')}}" />

<link rel="stylesheet" href="{{url('backend/css/jquery.dataTables.min.css')}}" />
<link rel="stylesheet" href="{{url('backend/css/responsive.dataTables.min.css')}}" />
<link rel="stylesheet" href="{{url('backend/css/buttons.dataTables.min.css')}}" />

<link rel="stylesheet" href="{{url('backend/css/summernote-bs4.css')}}" />

<link rel="stylesheet" href="{{url('backend/css/morris.css')}}">

<link rel="stylesheet" href="{{url('backend/css/material-icons.css')}}" />
